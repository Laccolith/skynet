...
public:
	...
	virtual int getAvailableTime( Unit unit, int ideal_time, int required_duration, Position starting_position, Position ending_position = Positions::None ) const = 0;
